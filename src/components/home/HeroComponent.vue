      ...
      <div class="row d-flex flex-column-reverse flex-lg-row">
        ...
        <div class="col-12 col-lg-6 d-flex align-self-center flex-column mt-md-0 pb-3">
          ...
          <button class="btn btn-primary w-100 my-primary-btn mt-1">
            <a class="text-white text-decoration-none" href="tel:+40310051198"><font-awesome-icon icon="phone-alt" style="margin-right: 10px" />Serviciu la fața locului în maxim 25 de minute</a>
          </button>
        </div>
      </div>
    </div>
