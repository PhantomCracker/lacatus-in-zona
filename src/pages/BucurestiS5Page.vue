      ...
      <div class="container">
        <div class="row pt-5 pb-5">
          <div class="col-lg-12 d-flex align-self-center flex-column mt-3 mt-md-0 pb-4">
            <h1 class="text-white text-start text-center">Lăcătuș în zonă -<span class="my-yellow"> București Sector 5</span></h1>
...
export default {
  ...
  methods: {
    track () {
      this.$ga.page('/bucuresti-sector5')
    }
  },
  metaInfo: {
    title: 'Servicii de lăcătuș în regim de urgență | București - Sector 5',
    meta: [
      {
        charset: 'utf-8'
      },
...
.hero {
  background-image: url("../../public/images/cities/Bucuresti-sector5.jpg");
