      ...
      <div class="container">
        <div class="row pt-5 pb-5">
          <div class="col-lg-12 d-flex align-self-center flex-column mt-3 mt-md-0 pb-4">
            <h1 class="text-white text-start text-center">Lăcătuș în zonă -<span class="my-yellow"> București Sector 6</span></h1>
            <ul class="text-center ps-0 pt-2">
              ...
              <li class="text-white">Rambursarea banilor garantată dacă nu am remediat problema </li>
...
export default {
  ...
  methods: {
    track () {
      this.$ga.page('/bucuresti-sector6')
    }
  },
  metaInfo: {
    title: 'Servicii de lăcătuș în regim de urgență | București - Sector 6',
    meta: [
      {
        charset: 'utf-8'
      },
      {
        vmid: 'description',
        name: 'description',
        content: 'Servicii de lăcătuș de urgență 24/7 în București. Lăcătușul local din București oferă, de asemenea, o gamă de servicii și consumabile concepute pentru a îmbunătăți securitatea casei sau a afacerii dumneavoastră'
      }
    ]
  }
}
...
.hero {
  background-image: url("../../public/images/cities/Bucuresti-sector6.jpg");
...
h1 {
  font-size: 2.5rem;
  &.with-border {
    border-left: 10px solid $ourBlue;
    padding-left: 25px;
    @media (max-width: 700px) {
      font-size: 3.5rem;
      padding-left: 5px;
...
.btn-primary {
  background-color: $ourBlue !important;
  border: none;
